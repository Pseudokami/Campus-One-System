      ...
      <div className="rounded-2xl border border-gray-200 bg-white p-12 shadow-sm flex flex-col items-center text-center space-y-8">
        <div className="space-y-2">
          ...
          <div className="flex items-center justify-center gap-4 text-[10px] font-bold uppercase tracking-widest">
            <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-primary"></div> Required <span className="text-red-500">*</span></span>
        ...
        <form className="w-full max-w-lg space-y-6">
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1 bg-white px-2 relative z-10 -mb-2 w-fit">Date <span className="text-red-500">*</span></label>
          ...
          <div className="space-y-1">
            <label className="text-[10px] font-bold text-gray-500 uppercase tracking-widest ml-1 bg-white px-2 relative z-10 -mb-2 w-fit">Search Class <span className="text-red-500">*</span></label>
